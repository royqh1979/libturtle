...
static void doDrawLine(int x0, int y0, int x1, int y1) {
...
static void fill2EllipseLines(int CX, int CY, int X, int Y, Color color) {
	int x1 = CX-X;
	int x2 = CX+X;
	if (x2<x1)
		std::swap(x1,x2);
...
static void doDrawPoint(int x, int y) {
	doFillCircle(x,y,pTurtle->pen_size/2,pTurtle->pen_color);
}
